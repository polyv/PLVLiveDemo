...
- (NSMutableAttributedString *)convertTextEmotionToAttachment:(NSString *)text font:(UIFont *)font {
    // 转为html
    NSMutableAttributedString *attributeString = [[NSMutableAttributedString alloc] initWithAttributedString:[self stringToHtmlAttributedString:text]];
    [attributeString setAttributes:@{NSFontAttributeName:font} range:NSMakeRange(0, attributeString.length)];
...
/// 字符串转富文本
- (NSAttributedString *)stringToHtmlAttributedString:(NSString *)htmlStr {
